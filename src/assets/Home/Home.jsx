        ...
        <div className={`flex flex-col md:flex-row items-start gap-12`}>
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed max-w-2xl">
              ...
              Passionate about crafting efficient, innovative web solutions with
            ...
            <div className="flex items-center space-x-6 pt-4">
              ...
              {[
                ...
                <a
                  key={label}
                  href={href}
                  className="text-gray-400 hover:text-amber-400 transform hover:scale-125 hover:-translate-y-1 transition-all duration-300"
                  aria-label={label}
                >
                  <Icon size={20} />
                </a>
